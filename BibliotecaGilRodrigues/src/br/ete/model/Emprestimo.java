...
public class Emprestimo{
    ...
    public int hashCode() {
        ...
        hash = 97 * hash + (this.atrasado ? 1 : 0);
        hash = 97 * hash + Objects.hashCode(this.dataDeEmprestimo);
        hash = 97 * hash + Objects.hashCode(this.dataDeDevolucaoPrevista);
        hash = 97 * hash + Objects.hashCode(this.dataDeDevolucao);
        hash = 97 * hash + Objects.hashCode(this.nomeAluno);
        hash = 97 * hash + Objects.hashCode(this.matricula);
        hash = 97 * hash + Objects.hashCode(this.tituloLivro);
        hash = 97 * hash + Objects.hashCode(this.idLivro);
        return hash;
    }
    ...
    public String toString() {
        return "Emprestimo{" + "id=" + id + ", atrasado=" + atrasado + ", dataDeEmprestimo=" + dataDeEmprestimo + ", dataDeDevolucaoPrevista=" + dataDeDevolucaoPrevista + ", dataDeDevolucao=" + dataDeDevolucao + ", nomeAluno=" + nomeAluno + ", matricula=" + matricula + ", tituloLivro=" + tituloLivro + ", idLivro=" + idLivro + '}';
    }   
