...
import br.ete.controller.AlunoSubsequenteController;
...
public class AlunoSubsequenteTela extends javax.swing.JFrame {

    AlunoSubsequenteDto aluno = new AlunoSubsequenteDto();
    AlunoSubsequenteController alunoController = new AlunoSubsequenteController();
    private MaskFormatter formatoTel;

    public AlunoSubsequenteTela() {
        super("Aluno Subsequente");
        initComponents();
        setVisible(true);
        listarTodos();
    }
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(32, 32, 32))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(cpftf, javax.swing.GroupLayout.PREFERRED_SIZE, 230, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void excluirbtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excluirbtActionPerformed
        if (idtf.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Campo de Código está vazio, escolha um Aluno!", "Aluno Subsequente", JOptionPane.WARNING_MESSAGE);
        } else {
            int escolha = JOptionPane.showConfirmDialog(null, "Confirma a exclusão?", "Aluno Subsequente", JOptionPane.YES_NO_OPTION);
            if (escolha == 0) {
    ...
    private void okbtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okbtActionPerformed
        if (nometf.getText().equals("") || matriculatf.equals("") || turmatf.getText().equals("") || emailtf.getText().equals("") || telefonetf.getText().equals("") || cpftf.getText().equals("")) {
    ...
    private void alunotbMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_alunotbMouseClicked
        ...
        idtf.setText(alunotb.getValueAt(alunotb.getSelectedRow(), AlunoSubsequenteTableModel.COL_ID_ALUNO).toString());
