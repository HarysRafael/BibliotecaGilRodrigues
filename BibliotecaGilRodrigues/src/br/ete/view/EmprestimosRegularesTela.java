...
public class EmprestimosRegularesTela extends javax.swing.JFrame {

    public EmprestimosRegularesTela() {
        super("Empréstimos Regulares");
        initComponents();
        setVisible(true);
        listarTodosRegulares();
    }
    ...
    // End of variables declaration//GEN-END:variables
            ...
            public void listarTodosRegulares() {

        try {
            Connection conn = Conexao.getConnection();
            String sql = "SELECT * FROM emprestimo WHERE dataDeDevolucao IS NULL AND atrasado = FALSE ORDER BY id DESC";
